...
loadout.Slot  = lurti.core.meta.class()

--- @param weapon Weapon
--- @param max_cd? DeltaTime
--- @return self
function loadout.Slot:init( weapon, max_cd )
  lurti.core.meta.init_super( loadout.Slot, self )
  self.weapon   = weapon
  self.bullet   = 1
...
loadout.Loadout = lurti.core.meta.class()

--- @param switch_sound Handle
--- @param slots Slot[]
--- @return self
function loadout.Loadout:init( switch_sound, slots )
  lurti.core.meta.init_super( loadout.Loadout, self )
